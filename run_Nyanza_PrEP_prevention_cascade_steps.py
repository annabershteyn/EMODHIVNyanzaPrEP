...
############# SET THESE: ########################
suite_name = 'Nyanza_PrEP_v3_redo_OralInno_Adherence61'
output_directory = "Nyanza_PrEP_v3_redo_OralInno_Adherence61"
...
scenarios = [
#["Counterfactual_Nyanza","cpnSQ",2099,[1,2,4,6],[],"All",15,29,[2020, 2099],[0,0],[0, 91, 92, 365],[0, 0, 0, 0]],
